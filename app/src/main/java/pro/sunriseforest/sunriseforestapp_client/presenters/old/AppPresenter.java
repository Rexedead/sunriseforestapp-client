...
//
//    @Override
//    public void selectedGoToRegistration(User user) {
//        log(String.format("selectedGoToRegistration(user=%s)", user));
//
...
//                logError("network selectedGoToRegistration: onFailure(), throwable=" + t.getMessage());
